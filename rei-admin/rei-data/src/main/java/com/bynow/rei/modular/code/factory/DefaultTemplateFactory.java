package com.bynow.rei.modular.code.factory;


import com.bynow.rei.ReiApplication;
import com.bynow.rei.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("bynow");
        genQo.setProjectPackage(ReiApplication.class.getPackage().getName());
