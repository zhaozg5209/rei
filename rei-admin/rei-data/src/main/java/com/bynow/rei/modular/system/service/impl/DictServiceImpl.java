...
import com.bynow.rei.core.exception.ReiException;
import com.bynow.rei.modular.system.dao.DictMapper;
...
import static com.bynow.rei.core.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new ReiException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new ReiException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
