...
import com.bynow.rei.core.base.tips.Tip;
import com.bynow.rei.core.common.annotion.BussinessLog;
import com.bynow.rei.core.common.annotion.Permission;
import com.bynow.rei.core.common.constant.Const;
import com.bynow.rei.core.common.constant.dictmap.UserDict;
import com.bynow.rei.core.common.constant.factory.ConstantFactory;
import com.bynow.rei.core.common.constant.state.ManagerStatus;
import com.bynow.rei.core.common.exception.BizExceptionEnum;
import com.bynow.rei.core.datascope.DataScope;
import com.bynow.rei.core.db.Db;
...
import com.bynow.rei.modular.system.factory.UserFactory;
import com.bynow.rei.modular.system.model.User;
import com.bynow.rei.modular.system.service.IUserService;
import com.bynow.rei.modular.system.transfer.UserDto;
import com.bynow.rei.modular.system.warpper.UserWarpper;
...
public class UserMgrController extends BaseController {
    ...
    @Autowired
    private ReiProperties reiProperties;
    ...
    public Object changePwd(@RequestParam String oldPwd, @RequestParam String newPwd, @RequestParam String rePwd) {
        ...
        if (user.getPassword().equals(oldMd5)) {
            ...
            throw new ReiException(BizExceptionEnum.OLD_PWD_NOT_RIGHT);
        }
    }
    ...
    public Tip edit(@Valid UserDto user, BindingResult result) throws NoPermissionException {
        ...
        if (ShiroKit.hasRole(Const.ADMIN_NAME)) {
            ...
            if (shiroUser.getId().equals(user.getId())) {
                ...
                throw new ReiException(BizExceptionEnum.NO_PERMITION);
            }
        }
    }
    ...
    public Tip delete(@RequestParam Integer userId) {
        ...
        if (userId.equals(Const.ADMIN_ID)) {
            throw new ReiException(BizExceptionEnum.CANT_DELETE_ADMIN);
        }
        assertAuth(userId);
    ...
    public Tip freeze(@RequestParam Integer userId) {
        ...
        //不能冻结超级管理员
        if (userId.equals(Const.ADMIN_ID)) {
            throw new ReiException(BizExceptionEnum.CANT_FREEZE_ADMIN);
        }
        assertAuth(userId);
    ...
    public Tip setRole(@RequestParam("userId") Integer userId, @RequestParam("roleIds") String roleIds) {
        ...
        //不能修改超级管理员
        if (userId.equals(Const.ADMIN_ID)) {
            throw new ReiException(BizExceptionEnum.CANT_CHANGE_ADMIN);
        }
        assertAuth(userId);
    ...
    public String upload(@RequestPart("file") MultipartFile picture) {
        ...
        try {
            String fileSavePath = reiProperties.getFileUploadPath();
            picture.transferTo(new File(fileSavePath + pictureName));
        } catch (Exception e) {
            throw new ReiException(BizExceptionEnum.UPLOAD_ERROR);
        }
        return pictureName;
    }
