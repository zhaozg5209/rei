...
import com.bynow.rei.core.support.BeanKit;
...
import com.bynow.rei.core.common.constant.dictmap.MenuDict;
import com.bynow.rei.core.common.constant.factory.ConstantFactory;
import com.bynow.rei.core.common.constant.state.MenuStatus;
...
import com.bynow.rei.modular.system.model.Menu;
import com.bynow.rei.modular.system.service.IMenuService;
import com.bynow.rei.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new ReiException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new ReiException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
