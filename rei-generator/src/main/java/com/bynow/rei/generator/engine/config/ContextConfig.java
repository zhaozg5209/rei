...
public class ContextConfig {
    ...
    private String templatePrefixPath = "reiTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\rei";//模板输出的项目目录
    ...
    private String proPackage = "com.bynow.rei.admin";
    private String coreBasePackage = "com.bynow.rei.core";
    private String modelPackageName = "com.bynow.rei.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.bynow.rei.modular.system.dao";    //model的dao
