...
import com.bynow.rei.generator.engine.SimpleTemplateEngine;
import com.bynow.rei.generator.engine.base.ReiTemplateEngine;
import com.bynow.rei.generator.engine.config.ContextConfig;
import com.bynow.rei.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doreiGeneration() {
        ReiTemplateEngine reiTemplateEngine = new SimpleTemplateEngine();
        reiTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        reiTemplateEngine.setSqlConfig(sqlConfig);
        reiTemplateEngine.setTableInfo(tableInfo);
        reiTemplateEngine.start();
    }
}
